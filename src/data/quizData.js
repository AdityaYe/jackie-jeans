...
export const QUIZ_QUESTIONS = [
  {
   ...
   voicePrompt: "Let's start. What's your height? You can answer in feet and inches.",
    type: "dropdown",
  ...
  },
  {
    ...
    voicePrompt: "What's your weight? You can answer in pounds or kilograms, or simply say 'skip'.",
    type: "number",
    unit: "lbs",
    required: false,
    skippable: true,
  ...
  },
  {
    ...
    voicePrompt: "What's your waist measurement? Please answer in inches.",
  ...
  },
  {
    ...
    voicePrompt: "What's your hip measurement? Please answer in inches.",
    type: "dropdown",
    options: hipOptions(),
    required: true,
  ...
  },
  {
    ...
    voicePrompt: "How do you like your jeans to fit at the waist? Choose snug, slightly relaxed, or relaxed.",
    type: "single-select",
  ...
  },
  {
    ...
    voicePrompt: "Where do you prefer the waistband to sit? Choose high rise, mid rise, or low rise.",
    type: "single-select",
  ...
  },
  {
    ...
    voicePrompt: "How should your jeans fit through the thighs? Choose fitted, relaxed, or loose.",
    type: "single-select",
  ...
  },
  {
    ...
    voicePrompt: "Which denim brands have you worn before? You can name one or more brands, then say 'done' when you've finished.",
    type: "multi-select",
    options: BRANDS,
    required: false,
  ...
  },
  {
    ...
    voicePrompt: "What size did you usually buy for each selected brand? You can answer with a number or letter size.",
    type: "brand-sizes",
    required: false,
    dependsOn: "brands",
  ...
  },
  {
    ...
    voicePrompt: "What's your biggest fit frustration? Choose waist gap, hip tightness, wrong length, thigh fit, rise issues, or other.",
    type: "single-select",
    options: [
